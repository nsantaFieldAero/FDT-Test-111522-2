...
Partial Public Class DataSet9
    ...
    Partial Public Class tblDrawingCertUMApprovalDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddtblDrawingCertUMApprovalRow(ByVal DwgRecordID As Integer, ByVal UMName As String, ByVal UMSpecialty As String, ByVal UMRecommendApproval As String, ByVal UMApproval As String, ByVal RequiredToApprove As Boolean, ByVal Comments As String) As tblDrawingCertUMApprovalRow
            Dim rowtblDrawingCertUMApprovalRow As tblDrawingCertUMApprovalRow = CType(Me.NewRow,tblDrawingCertUMApprovalRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, DwgRecordID, UMName, UMSpecialty, UMRecommendApproval, UMApproval, RequiredToApprove, Comments}
